...
//Name: Wall3Way.ma
//Last modified: Mon, Nov 21, 2016 12:02:09 AM
//Codeset: 1252
requires maya "2015";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.0922358806967889 13.16837499817569 -0.98659384758098412 ;
	setAttr ".r" -type "double3" -56.138352728598207 443.39999999985628 -2.7672120526356323e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 11.838267000775421;
...
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.2500033552399117 100.1 -3.4999840878033082 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 5.2501868421894642;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.55197936296463013 0.625 ;
	setAttr -s 2 ".uvst";
	...
	setAttr -s 4 ".pt[44:47]" -type "float3"  0 0 0.024575332 0 0 0.024575332 
		0 0 0.024575332 0 0 0.024575332;
	setAttr ".dr" 1;
...
createNode polyTweak -n "polyTweak10";
	setAttr ".uopa" yes;
	setAttr -s 3 ".tk";
	setAttr ".tk[42]" -type "float3" -0.092307262 0 0 ;
	setAttr ".tk[43]" -type "float3" -0.092307262 0 0 ;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
