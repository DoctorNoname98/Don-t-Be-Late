...
//Last modified: Mon, Nov 28, 2016 11:03:27 AM
//Codeset: 1252
requires maya "2015";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.2932130022732382 12.691857773271582 -5.0210696815804194 ;
	setAttr ".r" -type "double3" -47.738352727255993 486.19999999998322 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 11.296085304049779;
...
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.4772069002323041 100.1 -0.13806011575805055 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 2.8014668968124421;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.9231374505966266 2.9614653512110367 100.1 ;
createNode camera -s -n "frontShape" -p "front";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 1.7397087630618946;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 3.0798498550708917 -0.38523977321941882 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 10.11469401282876;
...
createNode transform -n "pCube5";
	setAttr ".t" -type "double3" 2.1070672520263942 2.9130186018552813 -0.25 ;
	setAttr ".s" -type "double3" 0.36934532421200233 0.72801632950683759 0.76804273492547381 ;
...
createNode transform -n "pCube6";
	setAttr ".t" -type "double3" 0.93464655974069721 2.9130186018552808 -0.25 ;
	setAttr ".s" -type "double3" 0.40787524285525778 0.72801632950683759 0.44766754986332152 ;
...
createNode mesh -n "pCubeShape6" -p "transform3";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".vt[0:7]"  -1.5 -4 0.25 1.5 -4 0.25 -1.5 4 0.25 1.5 4 0.25
		 -1.5 4 -0.25 1.5 4 -0.25 -1.5 -4 -0.25 1.5 -4 -0.25;
...
createNode transform -n "pCube8";
	setAttr ".t" -type "double3" 1.5 0 -0.2500000704446087 ;
	setAttr ".s" -type "double3" -1 1 -1 ;
	setAttr ".rp" -type "double3" -1.4919589169955578 0 -5.3838637225048068e-009 ;
	setAttr ".sp" -type "double3" 1.4919589169955578 0 -5.3838637225048068e-009 ;
	setAttr ".spt" -type "double3" -2.9839178339911157 0 0 ;
createNode mesh -n "pCube8Shape" -p "pCube8";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 16 ".pt[0:15]" -type "float3"  0 1.4901161e-008 0.25000009 
		0 1.4901161e-008 0.25000009 0 1.4901161e-008 0.25000009 0 1.4901161e-008 0.25000009 
		0 1.4901161e-008 0.25000009 0 1.4901161e-008 0.25000009 0 1.4901161e-008 0.25000009 
		0 1.4901161e-008 0.25000009 0 1.4901161e-008 0.25000009 0 1.4901161e-008 0.25000009 
		0 1.4901161e-008 0.25000009 0 1.4901161e-008 0.25000009 0 1.4901161e-008 0.25000009 
		0 1.4901161e-008 0.25000009 0 1.4901161e-008 0.25000009 0 1.4901161e-008 0.25000009;
createNode mesh -n "polySurfaceShape1" -p "pCube8";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 16 ".vt[0:15]"  0.0610888 0.0009534359 -0.057989314 1.16912484 0.0009534359 -0.057989314
		 0.0610888 5.82508373 -0.057989314 1.16912484 5.82508373 -0.057989314 0.0610888 5.82508373 -0.4420107
		 1.16912484 5.82508373 -0.4420107 0.0610888 0.0009534359 -0.4420107 1.16912484 0.0009534359 -0.4420107
		 -1.16912675 0.0009534359 -0.13808312 0.062193871 0.0009534359 -0.13808312 -1.16912675 5.82508373 -0.13808312
		 0.062193871 5.82508373 -0.13808312 -1.16912675 5.82508373 -0.3619169 0.062193871 5.82508373 -0.3619169
		 -1.16912675 0.0009534359 -0.3619169 0.062193871 0.0009534359 -0.3619169;
...
createNode script -n "uiConfigurationScriptNode";
	setAttr ".b" -type "string" (
		...
		+ "\t\t}\n\t} else {\n\t\t$label = `panel -q -label $panelName`;\n\t\tscriptedPanel -edit -l (localizedPanelLabel(\"Paint Effects\")) -mbv $menusOkayInPanels  $panelName;\n\t\tif (!$useSceneConfig) {\n\t\t\tpanel -e -l $label $panelName;\n\t\t}\n\t}\n\n\n\t$panelName = `sceneUIReplacement -getNextScriptedPanel \"scriptEditorPanel\" (localizedPanelLabel(\"Script Editor\")) `;\n\tif (\"\" == $panelName) {\n\t\tif ($useSceneConfig) {\n\t\t\t$panelName = `scriptedPanel -unParent  -type \"scriptEditorPanel\" -l (localizedPanelLabel(\"Script Editor\")) -mbv $menusOkayInPanels `;\n\t\t}\n\t} else {\n\t\t$label = `panel -q -label $panelName`;\n\t\tscriptedPanel -edit -l (localizedPanelLabel(\"Script Editor\")) -mbv $menusOkayInPanels  $panelName;\n\t\tif (!$useSceneConfig) {\n\t\t\tpanel -e -l $label $panelName;\n\t\t}\n\t}\n\n\n\tif ($useSceneConfig) {\n        string $configName = `getPanel -cwl (localizedPanelLabel(\"Current Layout\"))`;\n        if (\"\" != $configName) {\n\t\t\tpanelConfiguration -edit -label (localizedPanelLabel(\"Current Layout\")) \n\t\t\t\t-defaultImage \"\"\n\t\t\t\t-image \"\"\n\t\t\t\t-sc false\n\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"quad\\\" -ps 1 50 79 -ps 2 50 79 -ps 3 50 21 -ps 4 50 21 $gMainPane;\"\n"
...
connectAttr "polyNormal4.out" "pCube8Shape.i";
...
connectAttr "groupParts4.og" "polyNormal4.ip";
